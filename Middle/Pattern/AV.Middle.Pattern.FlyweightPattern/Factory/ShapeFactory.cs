using AV.Middle.Pattern.FlyweightPattern.Concrete;
using AV.Middle.Pattern.FlyweightPattern.Interface;
using log4net;
using System.Collections.Generic;
using System.Reflection;

namespace AV.Middle.Pattern.FlyweightPattern.Factory
{
